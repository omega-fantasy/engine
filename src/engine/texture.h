...
class TextureManager {
    ...
    private:
        ...
        Texture* generate_building(Size tile_size, Size building_size, const std::string& facade, const std::string& roof, const std::vector<std::pair<std::string, Point>>& objects);
